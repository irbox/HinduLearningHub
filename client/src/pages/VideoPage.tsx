...
import { 
  ChevronLeft, ThumbsUp, MessageSquare, Share2, Bookmark, User, 
  HelpCircle, BookOpen, Clock, Users, Sparkles, GraduationCap
} from "lucide-react";
  ...
  if (!video && id) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        ...
        <p className="mb-6">The video you are looking for doesn't exist or has been removed</p>
        <Link href="/videos">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-2/3">
          ...
          <div className="flex items-center text-sm text-muted-foreground mb-4">
            ...
            <span>{typeof video?.uploadDate === 'object' 
              ? formatDistanceToNow(new Date(video?.uploadDate as unknown as Date), { addSuffix: true })
          ...
          <div className="video-transcript bg-surface p-4 rounded-lg mb-6">
            <p className="text-sm whitespace-pre-line">{video?.description || 
              ...
              <div key={video.id} className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {video.views} views • {typeof video.uploadDate === 'object' 
                      ? formatDistanceToNow(new Date(video.uploadDate as unknown as Date), { addSuffix: true })
                      : video.uploadDate}
                  </p>
                </div>
