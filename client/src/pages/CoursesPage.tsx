    ...
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="courses-hero rounded-xl bg-gradient-to-r from-primary/90 to-primary p-4 sm:p-6 mb-8 text-white">
        ...
        <p className="text-base sm:text-lg opacity-90 mb-4 sm:mb-6 max-w-2xl">
          ...
          Sanskrit, meditation, and more. All courses are free and taught by
        ...
        <div className="flex flex-col md:flex-row md:items-center">
          <div className="md:w-2/3 mb-6 md:mb-0 md:pr-6">
            ...
            <p className="text-muted-foreground text-sm sm:text-base mb-4">
              Are you a scholar or practitioner with knowledge to share? Join
              our platform as a teacher and help spread the wisdom of Hindu
