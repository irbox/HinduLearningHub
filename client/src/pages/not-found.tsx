  ...
  return (
    <div className="container mx-auto px-4 py-16 min-h-[80vh] flex flex-col items-center justify-center text-center">
      <div className="mb-8 relative">
        <div className="text-[140px] font-bold text-primary opacity-10 select-none">404</div>
      ...
      <p className="text-muted-foreground text-lg max-w-md mb-8">
        The spiritual path you're looking for seems to have transcended this realm. 
