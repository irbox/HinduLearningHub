      ...
      <section className="mb-12">
        <div className="welcome-card rounded-xl bg-gradient-to-r from-primary/20 via-primary/10 to-background p-8 md:p-12 mb-8 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-muted-foreground">
            Discover lectures, books, and study materials from Govardhan Math, Puri, 
            and learn from the teachings of Shankaracharya tradition.
          </p>
          
          <form onSubmit={handleQuickSearch} className="max-w-2xl mx-auto flex flex-col sm:flex-row gap-2">
          ...
          <Card className="bg-primary/10 hover:bg-primary/15 transition cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Latest spiritual discourses and talks</p>
              </div>
          ...
          <Card className="bg-primary/10 hover:bg-primary/15 transition cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Key scriptures and commentaries</p>
              </div>
              <ChevronRight className="ml-auto h-5 w-5 text-primary" />
            </CardContent>
          </Card>
          ...
          <Card className="bg-primary/10 hover:bg-primary/15 transition cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Trending discussions and questions</p>
              </div>
              <ChevronRight className="ml-auto h-5 w-5 text-primary" />
            </CardContent>
          </Card>
        ...
        <Tabs defaultValue="videos" className="w-full">
          <div className="flex justify-between items-center mb-6">
            <TabsList className="grid w-full max-w-md grid-cols-2">
              <TabsTrigger value="videos" className="flex items-center gap-2 video-section">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-2xl font-semibold mb-1">
                  Videos <span className="text-primary">•</span> Puri Shankaracharya
                </h2>
                <p className="text-muted-foreground text-sm">
                  Explore the latest lectures, interviews, and discourses from Govardhan Math
                </p>
              </div>
          ...
          <TabsContent value="books" className="mt-0">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h2 className="text-2xl font-semibold mb-1">
                  Books <span className="text-primary">•</span> Shankaracharya & Advaita
                </h2>
                <p className="text-muted-foreground text-sm">
                  Explore sacred texts, commentaries, and philosophical books from Advaita tradition
                </p>
              </div>
