    ...
    <div className="container mx-auto px-4 py-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Access our comprehensive collection of texts, audio lectures, and
            study guides
          </p>
        </div>
      ...
      <Card className="mb-8 overflow-hidden bg-accent text-accent-foreground">
        <div className="md:flex">
          <div className="md:w-2/3 p-6 md:p-8">
            ...
            <p className="mb-4">
              Access our comprehensive collection of Sanskrit texts, including
              the Upanishads, Bhagavad Gita, and Brahma Sutras with translations
              and commentaries.
            </p>
      ...
      <Tabs defaultValue="all" className="mb-8">
        <TabsList className="mb-4 flex-wrap h-auto py-1">
          <TabsTrigger value="all" className="text-xs sm:text-sm px-2 py-1 h-8">
            All Materials
          </TabsTrigger>
          <TabsTrigger
            value="texts"
      ...
      <div className="mt-8 sm:mt-12 bg-muted p-4 sm:p-6 rounded-lg">
        ...
        <Button size="sm" className="sm:text-base sm:h-10">
          Search Materials
        </Button>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-sm sm:text-base mb-4 md:mb-0">
              Get unlimited access to all our study materials, exclusive
          ...
          <Button
            variant="secondary"
            size="sm"
            className="sm:text-base sm:h-10 whitespace-nowrap"
          >
            Become a Member
          </Button>
        </div>
