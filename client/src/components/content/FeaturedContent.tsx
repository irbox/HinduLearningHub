  ...
  return (
    <section className="mb-12">
      <h2 className="text-xl font-semibold mb-6 font-lora">
        Featured Content <span className="text-primary">•</span> Popular
        Lectures
      </h2>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/3">
              <h4 className="text-primary font-medium mb-4 font-lora">
                Related Lectures
              </h4>
              ...
              <div className="space-y-4">
                {relatedLectures.map((lecture) => (
                  <div
                    key={lecture.id}
                    className="flex items-start cursor-pointer hover:bg-surface/60 p-2 rounded-lg transition"
                  >
