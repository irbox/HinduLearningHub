    ...
    <section className="mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {materials.map(material => (
          <Card key={material.id} className="bg-surface overflow-hidden hover:shadow-lg transition-all duration-300">
            <CardContent className="p-6">
              <div className={`flex items-center justify-center h-12 w-12 rounded-lg bg-${material.buttonColor}/20 text-${material.buttonColor} mb-4`}>
